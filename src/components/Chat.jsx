...
const Chat = ({ onClose }) => {
  ...
  return (
    <div className="nav-item p-4 rounded-lg w-[370px]">
      ...
      <div className="mt-5 ">
        {chatData?.map((item, index) => (
          <div
            key={index}
            className="flex items-center gap-5 border-b-1 border-color dark:border-dark-color p-3 leading-8 cursor-pointer"
          >
