...
const UserProfile = ({ onClose }) => {
  ...
  return (
    <div className="nav-item rounded-lg w-[370px]">
      ...
      <div className="flex gap-5 items-center mt-6 border-color border-b-1 dark:border-dark-color pb-6">
      ...
      <div>
        {userProfileData.map((item, index) => (
          <div
            key={index}
            className="flex gap-5 border-b-1 border-color dark:border-dark-color p-4 hover:bg-light-gray cursor-pointer  dark:hover:bg-[#42464D]"
          >
            <button
              type="button"
